<?php
/** Front page for "if the shoe Fitz" (standalone Brat theme) */
get_header();
?>
<main id="primary" class="site-main fitz-home">
  ...
  <div class="fitz-container">
    <div class="row align-items-center g-4 hero-grid">
      <div class="col-lg-6 order-lg-2 hero-copy" data-aos="fade-left">
      ...
      <div class="col-lg-6 order-lg-1 hero-visual" data-aos="fade-right">
...
<div class="swiper newest-swiper" data-aos="fade-up">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" style="border-radius:18px;">
        ...
        <div class="modal-body">
          <p>We’re a sneaker and streetwear boutique focused on new releases and curated classics. Our mission is to offer authentic products, fast delivery, and a smooth shopping experience.</p>
        </div>
  ...
  <!-- BOTTOM VIDEO -->
  <section class="fitz-top-video" aria-label="Intro video">
    <video class="top-video" autoplay muted loop playsinline poster="<?php echo esc_url( get_stylesheet_directory_uri().'/assets/img/hero-sneakers.png'); ?>">
      <source src="<?php echo esc_url( get_stylesheet_directory_uri().'/assets/img/hero.mp4'); ?>" type="video/mp4">
    </video>
  </section>
