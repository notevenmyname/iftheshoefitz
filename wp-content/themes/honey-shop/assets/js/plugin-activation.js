jQuery(document).ready(function($) {
    'use strict';
    var this_obj = honey_shop_plugin_activate_plugin;

    $(document).on('click', '.honey-shop-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message honey-shop-plugin-install');
                button.addClass('button-primary honey-shop-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.honey-shop-recommended-plugins .honey-shop-activation-note').css('display','block');
    ...
    $(document).on('click', '.honey-shop-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .honey-shop-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .honey-shop-recommended-plugins').css('display','none');
    });
