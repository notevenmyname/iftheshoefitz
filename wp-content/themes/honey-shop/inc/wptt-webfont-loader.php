...
if ( ! class_exists( 'Honey_Shop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Honey_Shop_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'honey_shop_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function honey_shop_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Honey_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'honey_shop_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function honey_shop_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Honey_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
