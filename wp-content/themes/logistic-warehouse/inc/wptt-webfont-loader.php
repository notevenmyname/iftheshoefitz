...
if ( ! class_exists( 'Logistic_Warehouse_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Logistic_Warehouse_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$logistic_warehouse_contents = wp_remote_retrieve_body( $response );

			return $logistic_warehouse_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Logistic_Warehouse_WPTT_WebFont_Loader( $url );
