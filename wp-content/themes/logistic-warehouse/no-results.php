...
<header>
    <h1 class="entry-title"><?php esc_html_e( 'Nothing Found', 'logistic-warehouse' ); ?></h1>
</header>
...
<?php elseif ( is_search() ) : ?>
	...
	<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'logistic-warehouse' ); ?></p>
	<?php get_search_form(); ?>
